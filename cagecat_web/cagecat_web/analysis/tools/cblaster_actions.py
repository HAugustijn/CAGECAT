...
class CblasterPlotClustersTool(_DerivedCblasterTool):
    """Visualise selected clusters with clinker (via cblaster plot_clusters)."""

    name = "cblaster_plot_clusters"
    label = "Visualise clusters"
    description = "Plot selected clusters as an interactive clinker figure."
